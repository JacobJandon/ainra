...
| 2 — Stranger Test | **ALL GREEN 18/18, exit 0** | `docs/releases/stranger-test-2026-07-31.md` — pristine rust:1.96 container (Debian 13), zero credentials proven, anonymous https clone of the public URL @ aac68e6, pinned toolchain auto-synced, fmt 0 diffs, every row PASS incl. 4-way differential (36s) + byte-exact repro (361s) |
