...
`not-logged-binding-0001` runs in the **1105-vector corpus across four implementations** on every board. Their
...
*"canonicalization attack/fragility surface"*. One rulebook, 1105 vectors under it.
